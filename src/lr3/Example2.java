    ...
    public static void main(String[] args) {
        ...
        // SWITCH
            ...
            switch (a) {
                ...
                default -> System.out.println("Вы не ввели правильного дня недели. Возможно, стоит написать с заглавной буквы");
            }
        }
        else {
            System.out.println("Что-то пошло не так, возможные значения 1 или 2. Запустите программу заново.");
        }
        in.close();
    }
}